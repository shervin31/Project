...
class BST:
    ...
    def _remove_aux(self, node, key):
        value = None  # Initialize value here
    ...
    def __eq__(self, target):
        ...
        return self.__eq__aux(self._root, target._root) 
    ...
    def __eq__aux(self, source_node, target_node):
        ...
        if source_node is None and target_node is None:
            ...
            (self.__eq__aux(source_node._left, target_node._left) and 
            self.__eq__aux(source_node._right, target_node._right))
    ...
    def parent_r(self, key):
        ...
        if parent._value != key:
            ...
            value = self._parent_r_aux(parent, node, key)
    ...
    def _parent_r_aux(self, parent, node, key):
        ...
        if node is None:
            ...
            value = self._parent_r_aux(parent, node._left, key)
            parent = node
            node = node._left
    ...
    def _two_child_count_aux(self, node):
        ...
        if node is None:
            ...
            count = self._two_child_count_aux(node._left) and self._two_child_count_aux(node._right)
    ...
    def _one_child_count_aux(self, node):
        ...
        if node is None:
            ...
            count = self._one_child_count_aux(node._left) and self._one_child_count_aux(node._right)
    ...
    def node_counts(self):
        ...
        zero, one, two = self._node_counts_aux(node, one, two, zero)
    ...
    def levelorder(self):
        ...
        self._levelorder_aux(values, node)
        
        return values
    
        
    def _levelorder_aux(self, values, node):
